...
class Route : NSObject {
    ...
    dynamic var responseStatusCode = UInt(0)
    dynamic var responseDelay = UInt(0)
    dynamic var routeId = ""
    dynamic var isInternal = false
    dynamic var routeDisplayName = ""
    dynamic var routeDescription = ""
    dynamic var requestMethod = ""
    dynamic var requestUri = ""
    dynamic var requestOverrideRouteId = ""
    dynamic var requestQueryStringContains = ""
    dynamic var requestQueryStringEquals = ""
    dynamic var requestBodyJsonPath = ""
    dynamic var requestBodyJsonPathContains = ""
    dynamic var requestBodyJsonPathEquals = ""
    dynamic var responseJsonFile = ""
    dynamic var responseControllerId = ""
