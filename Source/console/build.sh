...
PRODUCT_PATH="./../../Products/console/mockifer"
...
echo 'Mockifer: Console: Copying app to product path...'
...
echo "Mockifer: Console: Build complete! Find 'mockifer' in the Products/console folder."
echo ''
echo '======================================================='
